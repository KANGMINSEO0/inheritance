...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *           supuer()는 부모클래스가 가지는 private 생성자를 제외한 나머지 생성자를 호출할 수 있도록 한 구문이다.
        * */

        Product product1 = new Product();
        System.out.println(product1.getInformation());      // 기본값으로 null값이 들어감
        ...
        System.out.println();
        Computer computer3 = new Computer("S-01234", "삼성", "갤럭시Z폴드2", 2398000, new java.util.Date() ,"퀄컴 스냅드래곤", 512, 12, "안드로이드");
